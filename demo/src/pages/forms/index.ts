...
export const group: SinkGroup = {
  ...
  pages: [
    ...
    { id: "date-picker", label: "Date picking", description: "Calendar, DatePicker/DateRangePicker and MonthPicker; Monday weeks, tokens only.", load: () => import("./date-picker.tsx") },
